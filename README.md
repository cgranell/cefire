...
* [¿Qué votaron tus vecinos en las elecciones generales? Los resultados del 28A por partido y por bloque izquierda-derecha, calle a calle](https://www.eldiario.es/politica/votaron-elecciones-generales-resultados-calle_0_894860668.html). El dioario, 2 Mayo 2019.
...
* [España en mapas. Una síntesis geográfica](http://www.ign.es/web/publicaciones-boletines-y-libros-digitales#DA-Espana-en-mapas), cada capítulo se puede [descargar individualmente](http://www.ign.es/web/ign/portal/espana-en-mapas)
...
* Open Street Map:
  ...
  * Otro ejemplo se encuentra en el uso directo de la herramienta QGIS para no solo enseñar una habilidad técnica a chicos de secundaria, sino el de generar proyectos que impacten a la comunidad asociada a la escuela. Lo que inició como un curso en el que se aprendía a usar la [herramienta SIG QGIS](https://qgis.org/en/site/about/case_studies/portugal_funchal.html), generó un proyecto para la ubicación de sitios para la gestión de residuos en el vecindario.
  * Movimientos como los de ciencia ciudadana han extendido el uso de las tecnologías SIG a complejas propuestas de integración de la ciudadanía en general, las escuelas y los centros de investigación. Ejemplos como [beepath](http://beepath.org/) hacen uso de tecnologías de geolocalización y SIG para promover el aprendizaje transversal de competencias STEM, la mejora en la producción de datos geográficos y la promoción del desarrollo científico en chicos de la escuela superior.
